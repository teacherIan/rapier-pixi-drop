...
async function start() {
  ...
  gsap.to(sapphireCounterText, { pixi: { text: 3497, alpha: 1  }, duration: 25, snap: { text: 1 }, delay: 15,  });
  gsap.to(rubyCounterText, { pixi: { text: 3436, alpha: 1  }, duration: 25, snap: { text: 1 }, delay: 15,  });
  gsap.to(amberCounterText, { pixi: { text: 3403, alpha: 1  }, duration: 25, snap: { text: 1 }, delay: 15,  });
  gsap.to(pearlCounterText, { pixi: { text: 3156, alpha: 1  }, duration: 25, snap: { text: 1 }, delay: 15,  });
